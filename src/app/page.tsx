...
export default function Home() {
  return (
    <main>
      ...
      <section className="flex flex-col items-center justify-center py-64 bg-black text-white text-center">
        ...
        <div className="flex text-start">
          <div className="mr-8 flex flex-col items-start">
            <div className="p-7 border border-white rounded-2xl">
              <Clock size={36} />
            </div>
            <h2 className="text-2xl font-bold mt-10">Fix emergencies fast</h2>
            <p className="text-[20px] mt-10 w-[500px]">
          ...
          <div className="mr-8 flex flex-col items-start">
            ...
            <p className="text-lg mt-10 w-[500px]">
      ...
      <section className="flex flex-col items-center justify-center py-64 bg-black text-white text-center">
        <h1 className="text-5xl md:text-7xl font-bold mb-10">Get in touch</h1>
